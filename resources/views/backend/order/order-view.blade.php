                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">Name: </label> <span>{{ $shipping->shipping_name }}</span>
                            </div>
                        </div><!-- col-4 -->

                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">Email: </label> <span>{{ $shipping->shipping_email }}</span>
                            </div>
                        </div><!-- col-4 -->

                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">Phone: </label> <span>{{ $shipping->shipping_phone }}</span>
                            </div>
                        </div><!-- col-4 -->

                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">Address: </label> <span>{{ $shipping->address }}</span>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">State: </label> <span>{{ $shipping->state }}</span>
                            </div>
                        </div><!-- col-4 -->

                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">Post Code: </label> <span>{{ $shipping->post_code }}</span>
                            </div>
                        </div><!-- col-4 -->
                    </div><!-- row -->
                </div><!-- form-layout -->
                ...
                <div class="col-xl-6 mg-t-25 mg-xl-t-0">
                    <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                <img height="50px" width="50px" src="{{ asset( $item->product->image_one  )}}" alt="">
                            </div>
                        </div>
                        @endforeach
                    </div><!-- card -->
