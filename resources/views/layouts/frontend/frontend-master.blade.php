...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> jhleon288@gmail.com</li>
                <li>call: 01632140038</li>
            </ul>
        </div>
    </div> --}}
    <!-- Humberger End -->
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            <div class="header__top__right__social">
                                ...
                                <a href="https://www.linkedin.com/in/jahedul-hasan-3957a813b/" target="_blank"><i class="fa fa-linkedin"></i></a>
                            </div>
                            {{-- <div class="header__top__right__language">
                                <img src="img/language.png" alt="">
                                <div>English</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        @php
                            $totalPrice = App\Models\Cart::all()
                        ...
                        <div class="header__cart__price">Price: <span>{{ $totalPrice }}</span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer__about">
                            ...
                            <ul>
                                <li>Address: Khilkhet, Dhaka</li>
                                <li>Phone: 01632140038</li>
                                <li>Email: jhleon288@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
                        <div class="footer__widget">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('contact') }}">Contact</a></li>
                                <li><a href="{{ route('contact') }}">Delivery infomation</a></li>
