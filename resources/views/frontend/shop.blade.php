                        ...
                        <div class="sidebar__item">
                            ...
                            <ul>
                                @foreach ($categories as $item)
                                    <li><a href="{{ route('category-wise--shop',$item->id) }}">{{ $item->category_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="sidebar__item">
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <h5><a href="{{ route('productdetails',$item->id) }}">{{ $item->product_name }}</a></h5>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="{{route('productdetails',$item->id) }}">{{ $item->product_name }}</a></h6>
                                    <h5>{{ $item->price }}</h5>
                                </div>
                            </div>
                        </div>
