                            ...
                            <div class="featured__item">
                                <div class="featured__item__pic set-bg" data-setbg="{{ asset($product->image_one) }}">
                                    <ul class="featured__item__pic__hover">
                                        <li><a href="{{ route('addWishlist',$product->id) }}"><i class="fa fa-heart"></i></a></li>
                                ...
                                <div class="featured__item__text">
                                    <h6><a href="{{ route('productdetails',$product->id) }}">{{ $product->product_name }}</a></h6>
                                    <h5>{{ $product->price }}</h5>
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach ($product_limits as $product_limit)
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="{{ asset($product_limit->image_one) }}" alt="">
                                        </div>
                                        <div class="latest-product__item__text">
                                            <h6>{{ $product_limit->product_name }}</h6>
                                            <span>{{ $product_limit->price }}</span>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
