                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <span>Visit For More Product</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="{{ asset($product->image_one) }}"
                                alt="">
                        </div>
                ...
                @foreach ($relatedProducts as $relatedProduct)
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="{{ asset($relatedProduct->image_one) }}">
                                <ul class="product__item__pic__hover">
                                    <li><a href="{{ route('addWishlist', $relatedProduct->id) }}"><i
                                                class="fa fa-heart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                    <form action="{{ route('add-to-cart', $relatedProduct->id) }}" method="post">
                                        @csrf
